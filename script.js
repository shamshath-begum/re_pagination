...
let indexOfLastPage=currentPage*cardPerPage;
let indexOffirstPage=indexOfLastPage-cardPerPage
let currentCard=data.slice(indexOffirstPage,indexOfLastPage)
...
function nextbtn(){
  let totalPage=Math.ceil(data.length/cardPerPage)
...
preEl.addEventListener("click",preBtn,false)
nextEl.addEventListener("click",nextbtn,false)
